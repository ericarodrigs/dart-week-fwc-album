...
class TextStyles {
  ...
  //secondaryFont
  TextStyle get textSecondaryRegular => TextStyle(
  ...
  TextStyle get labelTextField => textSecondaryRegular.copyWith(
  ...
  TextStyle get titlePrimaryColor => textPrimaryFontBold.copyWith(color: ColorsApp.i.primary, fontSize: 22);
}
