...
import 'package:dart_week_worldcup_album/app/pages/my_stickers/presenter/my_stickers_presenter_impl.dart';
...
class MyStickersPageRoute extends FlutterGetItPageRoute {
  const MyStickersPageRoute({super.key});
